print(table)
var table = ee.FeatureCollection("projects/researchgee/assets/PokharaMap"); // vector data load for feature collection
//this featurecollection above uses ee.Image.reduceToVectors
...
var training = image.sampleRegions({
  ...
  properties: ['class'],
 scale: 1000 //here scale is provided 1000 for faster execution as vectorized image in the native resolution (231.92 m) takes time to execute
});
